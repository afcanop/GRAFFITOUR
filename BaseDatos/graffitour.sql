...
CREATE DEFINER=`root`@`localhost` PROCEDURE `RU_RegistrarProductos` (IN `_NOMBREPRODUCTO` VARCHAR(50), IN `_DESCRIPCION` TEXT, IN `_IMAGEN` VARCHAR(200), IN `_Color` VARCHAR(50), IN `_marca` VARCHAR(50), IN `_Precio` FLOAT)  NO SQL
INSERT INTO `productos`(`NOMBREPRODUCTO`, `DESCRIPCION`, `IMAGEN`, `Color`, `Marca`, `Precio`) VALUES (_NOMBREPRODUCTO,_DESCRIPCION,_IMAGEN,_Color,_marca,_Precio)$$
...
INSERT INTO `productos` (`IDPRODUCTOS`, `NOMBREPRODUCTO`, `DESCRIPCION`, `IMAGEN`, `ESTADO`, `Color`, `Marca`, `Precio`, `categoria_IDCATEGORIA`) VALUES
(1, 'mekato', 'papitas de limon', 'dsfdmskl/dsafrsd.jpg', b'1', 'verde', 'frito leit', 500, 1);
