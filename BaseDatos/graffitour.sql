...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-05-2016 a las 02:09:22
...
CREATE DEFINER=`root`@`localhost` PROCEDURE `RU_RegistrarUsuarios`(IN `_PRIMER_NOMBRE` VARCHAR(50), IN `_SEGUNDO_NOMBRE` VARCHAR(50), IN `_PRIMER_APELLIDO` VARCHAR(50), IN `_SegundoApellido` VARCHAR(50), IN `_NUMERO_CONTACTO` INT, IN `_EDAD` INT, IN `_NumeroIdentificacion` VARCHAR(60), IN `_FechaNacimiento` DATE, IN `_Constrasena` VARCHAR(50))
    NO SQL
...
(17, 'sena', 'sena', 'sena', 'sena', 'sena', '2016-05-23', '11:11:00', 10, b'1'),
(18, 'sena2', 'sena2', 'sena2', 'sena2', 'sena2', '2016-05-23', '14:03:00', 4, b'1');
