...
<td> <?= $value->Estado == 1 ? "Activo" : "Inactivo" ?> 
</td>
<td> 
...
<div class="row">
<div class="col-md-6">
<div class="form-group form-animate-text">                                                                                                            <input type="number"  min="1" class="form-text " id="DOCI" name="DOCI" required>                                                                                                                 <span class="bar"></span>
<label><span class="glyphicon glyphicon-pencil"></span>Documento de identicación </label>
</div>
</div>
<div class="col-md-6">
<div class="form-group form-animate-text">
<input type="text" class="datepicker form-text dateAnimate" id="date" name="date">
<span class="bar"></span>
<label><span class="fa fa-calendar"></span> FECHA DE NACIMIENTO</label>
</div>
</div>
...
<div class="col-md-6">
<div class="form-group form-animate-text">
<input type="password"  class="form-text"  id="PrimeraContrasena" name="PrimeraContrasena">
<span class="bar"></span>
<label><span class="glyphicon glyphicon-pencil"></span>Cambiar contraseña </label>
</div>
</div>
...
<?php if ($value->Estado == 1) { ?>
<td> <a class="btn btn-success" onclick="CambiarEstado(<?= $value->IDUSUARIOS ?>, 0)"  role="button"> 
<span class="glyphicon glyphicon-eye-open "> Habilitar  </span>  </a> </td>
<?php } else { ?>
<td>  <a class="btn btn-danger" onclick="CambiarEstado(<?= $value->IDUSUARIOS ?>, 1)"  role="button"> 
<spam class="glyphicon glyphicon-eye-close" ></spam> Inhabilitar </a> 
</td>
<?php } ?> 
</tr>
<?PHP endforeach; ?>
