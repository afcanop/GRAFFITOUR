                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="form-group form-animate-text">
                                                <input type="text" class="form-text"  id="datetimepicker6" name="PrimerNombre" required>
                                                <span class="bar"></span>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group form-animate-text">
                                                <input type="text" class="form-text" id="datetimepicker7"  name="SegundoNombre" required>
                                                <span class="bar"></span>
